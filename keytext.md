# App Store Connect Metadata — QuoteSnap
...
|-------|-------|
| **App Name** | QuoteSnap |
| **Bundle ID** | com.zzoutuo.QuoteSnap |
...
This app is a professional quote and invoice generator for contractors. Key functionality to test:

1. Create a new quote with line items
2. Select a client from the client list
3. Choose an industry template
4. Generate and share a PDF
5. Convert an accepted quote to an invoice (Pro)
